...
<body>
    <div class="container">
        <header>
            <h1>Ministerio Apostolico y Profetico "Vision de Familia"</h1>
        ...
        <nav class="navbar">
            <ul>
                ...
                <li><a href="registro_personal.php"><i class="fas fa-user-plus"></i> Registro</a></li>
                <li><a href="seguimiento.php"><i class="fas fa-chart-line"></i> Seguimiento</a></li>
                <li><a href="exportacion.php"><i class="fas fa-file-export"></i> Exportación</a></li>
                <li><a href="ministerio.php"><i class="fas fa-hands-praying"></i> Ministerio</a></li>
                <li><a href="hcm.php"><i class="fas fa-home"></i> HCM</a></li>
                <li><a href="peticiones.php"><i class="fas fa-pray"></i> Peticiones</a></li>
