...
:root {
 ...
 <body>
  ...
  <?php $querymostrar = mysqli_query($conn,"SELECT * FROM hcm WHERE id= '$hcm'");
   ...
   ?>
    <h1 align="center">Registro de Creyentes Nuevos</h1>
    <h2 align="center">HCM: <?php echo $hcmexacto['nombre_lugar'];  ?></h2>
    <?php 
            $querynuevos = mysqli_query($conn,"SELECT * FROM nuevos INNER JOIN hcm_asignado_nuevo ON nuevos.id=hcm_asignado_nuevo.id_usuario WHERE hcm_asignado_nuevo.id_hcm='$hcm' ORDER BY MONTH(fecha), DAY(fecha)");
            ...
            <?php
                      ...
                      echo "Total de creyentes: $comprobacion_nuevos ";
                ?>
 </body>
 </html>
